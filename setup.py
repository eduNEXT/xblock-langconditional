#!/usr/bin/env python
"""
Package metadata for langconditional.
"""
import os
import re
import sys
...
VERSION = get_version('langconditional', '__init__.py')
...
setup(
    name='xblock-langconditional',
    version=VERSION,
    description="""Conditional Xblock for language preferences.""",
    long_description=README + '\n\n' + CHANGELOG,
    author='eduNEXT',
    author_email='technical@edunext.co',
    url='https://github.com/eduNEXT/xblock-langconditional',
    packages=find_packages(
        include=['langconditional', 'langconditional.*'],
        exclude=["*tests"],
    ),
    ...
    entry_points={
        'xblock.v1': [
            'langconditional = langconditional:LangConditionalXblock',
        ]
    },
    package_data=package_data("langconditional", ["static", "public"]),
)
