...
"""
xblock-langconditional documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'xblock-langconditional',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/eduNEXT/xblock-langconditional",
...
#
# html_title = 'xblock-langconditional v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'Conditional Xblock for language preferences.',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'langconditional'),
                os.path.join(root_path, 'langconditional/migrations')])
